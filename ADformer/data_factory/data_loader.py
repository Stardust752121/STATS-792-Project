...
class NIPS_TS_GECCOSegLoader(object):
    def __init__(self, data_path, win_size, step, mode="train"):
        self.mode = mode
        self.step = step
        self.win_size = win_size
...
class NIPS_TS_CreditcardSegLoader(object):
    def __init__(self, data_path, win_size, step, mode="train"):
        self.mode = mode
        self.step = step
        self.win_size = win_size
...
def get_loader_segment(data_path, batch_size, win_size=100, step=100, mode='train', dataset='KDD'):
    ...
    elif (dataset == 'NIPS_TS_GECCO'):
        dataset = NIPS_TS_GECCOSegLoader(data_path, win_size, step, mode)
    elif (dataset == 'NIPS_TS_Creditcard'):
        dataset = NIPS_TS_CreditcardSegLoader(data_path, win_size, step, mode)
